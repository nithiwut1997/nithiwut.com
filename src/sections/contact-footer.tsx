        ...
        <div className="grid gap-10 border-b border-white/10 pb-12 md:grid-cols-[1fr_0.8fr]">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-zinc-400">
              Based in {contact.location}. Reach out about senior software or
              backend engineering opportunities involving Java, cloud-native
              systems, platform delivery, or production reliability.
            </p>
          </div>
